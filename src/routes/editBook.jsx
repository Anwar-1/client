...
function editBook() {
 ...
 const baseUrl = `https://server-fzg6.onrender.com/api/books/${urlSlug.slug}`;
  ...
  const removeBook = async (e) => {
    ...
    try {
      const response = await fetch(
       ...
       "https://server-fzg6.onrender.com/api/books/" + bookId,
        {
          method: "DELETE",
        }
      );
          ...
          <div className="col-1">
            ...
            {image ? (
              ...
              <img
               ...
               src={`https://server-fzg6.onrender.com/uploads/${thumbnail}`}
                alt="preview image"
              />
            )}
            <input
